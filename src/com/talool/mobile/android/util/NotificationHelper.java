...
public class NotificationHelper {
    ...
    private void newNotification(int notificationId, String notificationTitle, String notificationMessage, int totalNotifications, Object o) {
        ...
        NotificationManager mNotifyMgr = (NotificationManager) applicationContext.getSystemService(Context.NOTIFICATION_SERVICE);
        // Builds the notification and issues it.
        mNotifyMgr.notify(currentNotificationId, builder.build());
    }
